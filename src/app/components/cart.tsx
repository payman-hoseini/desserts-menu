...
import { selectList } from "./store/cartSlice"
...
export default function Cart (){
    ...
    list.map(product => product.count !=0 ? setCart(cart+1) : setCart)
    return (
        <>
            <div className="bg-white rounded-lg p-6">
                <h2 className="font-bold text-Red text-2xl">{`Your Cart(${cart})`}</h2>
