...
export default function Cart (){
    ...
    return (
        <>
            ...
            {
                showModal && 
                <div className="fixed z-10 left-0 top-0 w-full h-full bg-black bg-opacity-50 grid place-content-center">
                            ...
                            <div className="mt-5 bg-Rose-50 rounded p-6">
                                {
                                    ...
                                    <>
                                        <div className="flex items-center justify-between border-b border-b-Rose-100 pb-3">
                                                <div className="flex items-center">
                                                    <img className="rounded-lg w-[23%]" src={product.product.image.thumbnail} alt={product.product.name} />
                                                    <div className="ml-3">
