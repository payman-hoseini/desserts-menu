        ...
        <>
                ...
                <div className={`flex flex-col mb-5 ${(total==0) ? "items-center mt-8" : "mt-1"}`}>
                    {
                        ...
                        <>
                            <div className="flex justify-between items-center py-4 border-b-Rose-100 border-b">
                                <div>
                                    <p className="font-semibold text-sm md:text-base text-Rose-900">{p.product.name}</p>
                    ...
                    }
                    {
                        ...
                        <>
                            <div className="mt-4 flex justify-between items-center">
                                <p className="text-Rose-900 text-sm md:text-base">Order Total</p>
                                <p className="font-bold text-2xl md:text-3xl">${sum}</p>
                            </div>
                            <div>
                                <div>
                                    <div className="flex items-center justify-center mt-7 bg-Rose-50 py-4 rounded-md">
                                        ...
                                        <p className="ml-2 text-xs md:text-base">This is a <span className="font-semibold">carbon-neutral</span> delivery</p>
                                    </div>
                                    <button onClick={() => {setShowModal(true)}} className="bg-Red text-white text-sm md:text-base font-semibold w-full mt-6 py-4 rounded-full hover:bg-red-800">
                                        Confirm Order
                                    </button>
                                </div>
                            </div>
            ...
            {/* Modal */}
            {
                ...
                <div ref={modalRef} className="fixed  z-10 left-0 top-0 w-full h-full bg-black bg-opacity-50 grid md:place-content-center">
                    <div className="bg-white py-8 mt-20 px-8 md:rounded-lg rounded-t-xl md:w-[25vw]">
                        <div>
                        ...
                        <div className="mt-5">
                            <h2 className="text-5xl md:text-3xl font-bold text-Rose-900">Order Confirmed</h2>
                            <p className="text-Rose-400 md:text-xs text-lg font-semibold mt-1">We hope you enjoy your food!</p>
