...
import { selectList, selectTotal } from "./store/cartSlice"
                ...
                <div className={`flex flex-col mb-5 ${(total==0) ? "items-center mt-8" : "mt-1"}`}>
                    {
                        ...
                        <>
                            <div className="flex justify-between items-center py-4 border-b-Rose-100 border-b">
                                ...
                                <button className="border-2 border-[#CAAFA7] rounded-full p-[2px]">
                        ...
                        <>
                            ...
                            <div>
                                <div>
                                    ...
                                    <button className="bg-Red text-white font-semibold w-full mt-6 py-4 rounded-full">
                                        Confirm Order
                                    </button>
                                </div>
                            </div>
