                ...
                <div>
                    <div className="relative">
                        ...
                        {/*  */}
                        {
                            ...
                            <button onClick={addtoCart} className="bg-white md:left-[30%] left-[25%] flex  px-5 py-2 mx-auto rounded-full border border-Rose-500 absolute  -bottom-5  hover:text-Red hover:border-Red">
                            ...
                            :
                            <div className="bg-Red md:left-[30%] left-[25%] flex items-center space-x-10  px-2 py-2 mx-auto rounded-full border border-Red absolute -bottom-5">
