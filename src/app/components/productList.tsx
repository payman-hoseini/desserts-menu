...
import { addToCart, updateList } from "./store/cartSlice";
        ...
        {/* koli */}
                ...
                <div>
                    <div className="relative">
                        ...
                        {/* left-[30%] */}
                        <button onClick={addtoCart} className="bg-white flex  px-5 py-2 mx-auto rounded-full border border-Rose-500 absolute  -bottom-5 trans hover:text-Red hover:border-Red">
