        ...
        {/* koli */}
                ...
                <div>
                    <div className="relative">
                        <img src={product.image.desktop} alt={product.name} className={`rounded-lg ${productCount?.count == undefined ? '' : 'border-[3px] border-Red'}`}/>
                        {/*  */}
                        {
                            (productCount?.count == undefined) ?
                            <button onClick={addtoCart} className="bg-white left-[30%] flex  px-5 py-2 mx-auto rounded-full border border-Rose-500 absolute  -bottom-5  hover:text-Red hover:border-Red">
                            ...
                            :
                            <div className="bg-Red left-[30%] flex items-center space-x-10  px-2 py-2 mx-auto rounded-full border border-Red absolute -bottom-5">
