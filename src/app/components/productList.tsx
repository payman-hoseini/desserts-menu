                ...
                <div>
                    <div className="relative">
                        ...
                        {/* left-[30%] */}
                        {
                            ...
                            <button onClick={addtoCart} className="bg-white flex  px-5 py-2 mx-auto rounded-full border border-Rose-500 absolute  -bottom-5  hover:text-Red hover:border-Red">
                            ...
                            :
                            <div className="bg-Red flex items-center space-x-8  px-2 py-2 mx-auto rounded-full border border-Red absolute -bottom-5">
